...
// NOTE: Don't exceed kMaxTimeoutMs. Typically 130ms.
          ...
          //Note from Bart Huylebroeck:
          //find IRremoteESP8266.h and comment out all defines related to air conditioners,
          //starting at "#ifndef DECODE_CARRIER_AC"
          //ending at "#define DECODE_AC false"
          //end force DECODE_AC to false ...
#if DECODE_AC
