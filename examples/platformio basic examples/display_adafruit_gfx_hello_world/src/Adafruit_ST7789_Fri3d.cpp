// This is the Adafruit GFX library for the Fri3d badge 2024, which uses the GC9307 display driver, similar to ST7789
// The standard adafruit library https://github.com/adafruit/Adafruit-ST7735-Library ST7789 is not 100% compatible, so some adaptations were necessary
...
*/
Adafruit_GFX_Fri3dBadge2024_TFT::Adafruit_GFX_Fri3dBadge2024_TFT(int8_t cs, int8_t dc, int8_t mosi, int8_t sclk,
                                 int8_t rst)
//    : Adafruit_ST77xx(240, 320, cs, dc, mosi, sclk, rst) {}
    : Adafruit_ST77xx(240, 296, cs, dc, mosi, sclk, rst) {}
...
/*!
    ...
    @param  rst  Reset pin # (optional, pass -1 if unused)
*/
Adafruit_GFX_Fri3dBadge2024_TFT::Adafruit_GFX_Fri3dBadge2024_TFT(int8_t cs, int8_t dc, int8_t rst)
//    : Adafruit_ST77xx(240, 320, cs, dc, rst) {}
    : Adafruit_ST77xx(240, 296, cs, dc, rst) {}
...
/*!
    ...
    @param  rst       Reset pin # (optional, pass -1 if unused)
*/
Adafruit_GFX_Fri3dBadge2024_TFT::Adafruit_GFX_Fri3dBadge2024_TFT(SPIClass *spiClass, int8_t cs, int8_t dc,
                                 int8_t rst)
//    : Adafruit_ST77xx(240, 320, spiClass, cs, dc, rst) {}
    : Adafruit_ST77xx(240, 296, spiClass, cs, dc, rst) {}
#endif // end !ESP8266
...
*/
/**************************************************************************/
void Adafruit_GFX_Fri3dBadge2024_TFT::init(uint16_t width, uint16_t height, uint8_t mode) {
...
*/
/**************************************************************************/
void Adafruit_GFX_Fri3dBadge2024_TFT::setRotation(uint8_t m) {
  uint8_t madctl = 0;
...
//    madctl = ST77XX_MADCTL_MX | ST77XX_MADCTL_MY | ST77XX_MADCTL_RGB;
    madctl = ST77XX_MADCTL_MY | ST77XX_MADCTL_BGR;
    _xstart = _colstart;
    _ystart = _rowstart;
    _width = windowWidth;
...
//    madctl = ST77XX_MADCTL_MY | ST77XX_MADCTL_MV | ST77XX_MADCTL_RGB;
    madctl = ST77XX_MADCTL_MX |ST77XX_MADCTL_MY | ST77XX_MADCTL_MV | ST77XX_MADCTL_BGR;
    _xstart = _rowstart;
    _ystart = _colstart2;
    _height = windowWidth;
    _width = windowHeight;
  ...
  case 2:
    ...
    madctl = ST77XX_MADCTL_MX | ST77XX_MADCTL_BGR;
    _xstart = _colstart2;
    _ystart = _rowstart2;
    _width = windowWidth;
    _height = windowHeight;
  ...
  case 3:
    ...
    madctl = ST77XX_MADCTL_MV | ST77XX_MADCTL_BGR;
    _xstart = _rowstart2;
    _ystart = _colstart;
    _height = windowWidth;
    _width = windowHeight;
